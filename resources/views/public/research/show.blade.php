		  ...
		  <ol class="bg-white rounded-md shadow px-6 flex space-x-4">
			...
			<li class="flex">
			  <div class="flex items-center space-x-4">
				...
				<a href="{{ route('research.show', $post) }}" aria-current="page" class="text-sm leading-5 font-medium text-gray-500 hover:text-gray-700 transition duration-150 ease-in-out">{{ $post->title}}</a>
			  </div>
			</li>
		  </ol>
		</nav>	
